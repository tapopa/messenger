        ...
        Obx(() {
          ...
          switch (c.page.value) {
                ...
                if (c.signInAs == null) ...[
                  ...
                  Padding(
                    ...
                    child: SignButton(
                      ...
                      onPressed: () =>
                          c.page.value = IntroductionStage.accountCreating,
            ...
            case IntroductionStage.signInWithEmailCode:
              header = ModalPopupHeader(
                text: 'label_sign_in_with_one_time_code'.l10n,
                onBack: () => c.page.value = IntroductionStage.signInWithEmail,
                close: false,
              );
            ...
            case IntroductionStage.accountCreated:
              header = ModalPopupHeader(
                text:
                    c.myUser.value == null || c.myUser.value?.id.isLocal == true
