                  ...
                  switch (c.page.value) {
                      ...
                      children = [
                        ...
                        Padding(
                          ...
                          child: SignButton(
                            ...
                            title: 'label_one_time_code'.l10n,
                    ...
                    case IntroductionStage.signInWithEmailCode:
                      ...
                      children = [
                        ...
                        const SizedBox(height: 16),
                        Text(
                          'label_one_time_code_has_been_sent_to_emails'.l10n,
                          style: style.fonts.small.regular.secondary,
                        ),
                        const SizedBox(height: 25),
                        ReactiveTextField(
                          ...
                          obscure: c.obscureOneTimeCode.value,
                          onSuffixPressed: c.obscureOneTimeCode.toggle,
                          trailing: Center(
                            child: SvgIcon(
                              c.obscureOneTimeCode.value
                                  ? SvgIcons.visibleOff
                                  : SvgIcons.visibleOn,
                            ),
                          ),
                    ...
                    case IntroductionStage.signUp:
                      ...
                      children = [
                        ...
                        SignButton(
                          ...
                          icon: const SvgIcon(SvgIcons.password),
                          onPressed: () => c.page.value =
                              IntroductionStage.signUpWithPassword,
                        ),
                        const SizedBox(height: 16),
                        SignButton(
                          key: const Key('Email'),
                      ...
                      children = [
                        ...
                        Text.rich(
                          TextSpan(
                            children: [
                              TextSpan(
                                text: 'alert_by_proceeding_you_accept_terms1'
                                    .l10n,
                              ),
                              TextSpan(
                                text: 'alert_by_proceeding_you_accept_terms2'
                                    .l10n,
                                style: style.fonts.small.regular.primary,
                              ...
                              TextSpan(
                                text: 'alert_by_proceeding_you_accept_terms3'
                                    .l10n,
                              ),
                            ],
                          ),
