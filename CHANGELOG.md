...
- UI:
    ...
    - Monetization tab:
        ...
        - Display total balances in transactions. ([#48])
        - Your prices page texts, blocks and illustrations. ([#48])
        - Your promotion page texts, blocks and illustrations. ([#48])
        - Your partner page texts, blocks and illustrations. ([#48])
