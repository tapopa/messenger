...
btn_link_management = Link management
btn_link_management_subtitle = List of your links
...
btn_promote_yourself_subtitle = Cooperation with promoters
...
btn_view_donation = View donation
btn_your_links = Your links
...
err_donations_has_minimum = User {$user} has set up minimum donation amount: {$amount}
...
label_add_application_to_desktop = Add application to desktop
label_add_application_to_dock = Add application to Dock
label_add_application_to_home_screen = Add application to the Home Screen
...
label_beneficiary_account_number = Beneficiary account number
...
label_card_processing_services_are_provided_by_paypal = Card processing services are provided and secured by PayPal. A secure payment card processing form by PayPal is used. Encrypted channel by PayPal is used. We do not have access to the payment data.
...
label_commission_up_to_amount_usdc = Commission: up to {$amount} USDC
label_commission_up_to_amount_usdt = Commission: up to {$amount} USDT
label_commission_value = Commission: {$value}
label_commission_value_plus_percent = Commission: {$value} + {$percent}%
...
label_currency_of_account = Currency of account
...
label_install_ios_web_application2_1 = Find the{" "}
label_install_ios_web_application2_2 = "Share"
label_install_ios_web_application2_3 = {" "}button in your browser
label_install_ios_web_application3_1 = Find{" "}
label_install_ios_web_application3_2 = "Add to Home Screen"
label_install_ios_web_application3_3 = {" "}option
label_install_ios_web_application3_4 = Add to Home Screen
label_install_ios_web_application4_1 = Tap the{" "}
label_install_ios_web_application4_2 = "Add"
label_install_ios_web_application4_3 = {" "}button
label_install_macos_web_application = Install macOS Web Application
label_install_macos_web_application1 = To add Tapopa to your Dock:
label_install_macos_web_application2_1 = Find the{" "}
label_install_macos_web_application2_2 = "Share"
label_install_macos_web_application2_3 = {" "}button in your browser
label_install_macos_web_application3_1 = Find{" "}
label_install_macos_web_application3_2 = "Add to Dock"
label_install_macos_web_application3_3 = {" "}option
label_install_macos_web_application3_4 = Add to Dock
label_install_macos_web_application4_1 = Tap the{" "}
label_install_macos_web_application4_2 = "Add"
label_install_macos_web_application4_3 = {" "}button
...
label_minimum_amount_semicolon = Minimum amount:{" "}
label_mobile_apps = Mobile apps
label_monetization = Monetization
...
label_operation_available = Available
...
label_operation_hold_days = Hold. {$days} days.
...
label_order_payment = Order withdrawal
...
label_payment_card = Payment card
label_payouts_and_information = Your money
label_paypal = PayPal
label_paypal_account_email = PayPal account e-mail
label_paypal_account_email_example = dummy@example.com
label_paypal_in_progress_bottom_description = To report any problems contact Support Service and provide your PayPal account e-mail, Tapopa ID, Transaction ID.
...
label_recover_account_description = Specify your Tap ID, login or E-mail.
...
label_secured_processing = Secured processing
...
label_set_your_prices = Your prices
...
label_top_up_by_payment_card = Top up by Payment card
...
label_transaction_is_ready_to_begin = Transaction is ready to begin.
label_transaction_unfinished = Transaction unfinished.
...
label_usdc_network_type = USDC - Network type
label_usdc_optimism = USDC - Optimism (OP Mainnet)
label_usdc_tag_memo_etc = Additional payment and/or recipient identifier
label_usdc_tag_memo_etc_example = Tag, memo, identifier, comment, etc.
label_usdc_wallet_number = Wallet number
...
label_your_monetization_settings_for_user = Your monetization settings for the user {$user}
