  ...
  final ArgParser cli = ArgParser()
    ..addMultiOption(
      ...
      defaultsTo: [
        ...
        'btn_close_button',
        'label_account',
        'label_card_processing_services_are_provided_by_paypal',
        'label_name',
        'label_operation_label_failed',
        'label_paypal_popup_window_instruction',
        'label_secured_processing',
        'label_to_be_paid',
        'label_to_make_payment_secure_paypal_page_will_open',
        'label_top_up_option',
        'label_transaction_is_being_processed',
        'label_transaction_is_ready_to_begin',
        'label_transaction_unfinished',
      ],
