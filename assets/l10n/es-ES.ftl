...
btn_close = Cerrar
btn_close_button = Cerrar ventana
btn_collapse_all = Reducir todo
...
btn_hide = Ocultar
btn_hide_balance = Ocultar saldo
...
btn_link_management = Gestión de enlaces
btn_link_management_subtitle = Lista de tus enlaces
...
btn_promote_yourself_subtitle = Cooperación con promotores
...
btn_select_currency_of_account = Seleccionar moneda de la cuenta
...
err_donations_has_minimum = El usuario {$user} ha establecido un importe mínimo de donación: {$amount}
...
label_add_application_to_desktop = Agregar aplicación al escritorio
label_add_application_to_dock = Agregar aplicación al Dock
label_add_application_to_home_screen = Agregar aplicación a la pantalla de inicio
...
label_all_links_amount = Todos los enlaces: {$amount}
...
label_australian_dollar = Dólar australiano
label_author = Autor
...
label_balance_exceeded = Saldo excedido
label_base = Base
label_beneficiary = Beneficiario
label_beneficiary_account_number = Número de cuenta del beneficiario
...
label_camera = Cámara
label_canadian_dollar = Dólar canadiense
label_card_processing_services_are_provided_by_paypal = Los servicios de procesamiento de tarjetas son proporcionados y protegidos por PayPal. Se utiliza un formulario seguro de procesamiento de tarjetas de PayPal. Se utiliza un canal cifrado de PayPal. No tenemos acceso a los datos de pago.
...
label_chinese_yuan_renminbi_offshore = Yuan chino renminbi offshore
...
label_commission_up_to_amount_usdc = Comisión: hasta {$amount} USDC
label_commission_up_to_amount_usdt = Comisión: hasta {$amount} USDT
label_commission_value = Comisión: {$value}
label_commission_value_plus_percent = Comisión: {$value} + {$percent}%
...
label_default_price_settings = Configuración de precios predeterminada
...
label_indonesian_rupiah = Rupia indonesia
label_information = Información
label_install_ios_web_application = Instalar aplicación web para iOS
label_install_ios_web_application1 = Para añadir Tapopa a la pantalla de inicio de tu iPhone:
label_install_ios_web_application2_1 = Busca el botón{" "}
label_install_ios_web_application2_2 = "Compartir"
label_install_ios_web_application2_3 = {" "}en tu navegador
label_install_ios_web_application3_1 = Busque la opción{" "}
label_install_ios_web_application3_2 = "Agregar a la pantalla de inicio"
label_install_ios_web_application3_3 = {""}
label_install_ios_web_application3_4 = Agregar a la pantalla de inicio
label_install_ios_web_application4_1 = Pulsa el botón{" "}
label_install_ios_web_application4_2 = "Añadir"
label_install_ios_web_application4_3 = {""}
label_install_macos_web_application = Instalar la aplicación web de macOS
label_install_macos_web_application1 = Para añadir Tapopa a tu Dock:
label_install_macos_web_application2_1 = Busca el botón{" "}
label_install_macos_web_application2_2 = "Compartir"
label_install_macos_web_application2_3 = {" "}en tu navegador
label_install_macos_web_application3_1 = Busque la opción{" "}
label_install_macos_web_application3_2 = "Agregar al Dock"
label_install_macos_web_application3_3 = {""}
label_install_macos_web_application3_4 = Agregar al Dock
label_install_macos_web_application4_1 = Pulsa el botón{" "}
label_install_macos_web_application4_2 = "Añadir"
...
label_intermediary_bank_account_number = Número de cuenta bancaria del banco intermediario
label_intermediary_bank_account_number_example = 0000000000000000000
label_intermediary_bank_address = Dirección del banco intermediario
label_intermediary_bank_address_example = Dirección del banco
label_intermediary_bank_name = Nombre del banco intermediario
label_intermediary_bank_name_example = Nombre del banco
label_intermediary_bank_swift_code = Código SWIFT del banco intermediario
label_intermediary_bank_swift_code_example = Código SWIFT
...
label_japanese_yen = Yen japonés
label_kb = {$amount} KB
...
label_mexican_peso = Peso mexicano
...
label_monetization = Monetización
...
label_new_zealand_dollar = Dólar neozelandés
...
label_norwegian_krone = Corona noruega
...
label_payment_card = Tarjeta de pago
label_payouts_and_information = Tu dinero
label_paypal = PayPal
...
label_pound_sterling = Libra esterlina
...
label_recover_account_description = Ingrese su Tap ID, usuario o e-mail
...
label_secured_processing = Procesamiento seguro
...
label_set_your_prices = Sus precios
...
label_sign_in_input = Tap ID, usuario o e-mail
...
label_singapore_dollar = Dólar de Singapur
label_solana = Solana
...
label_swedish_krona = Corona sueca
label_swift_transfer = Transferencia SWIFT
label_swiss_franc = Franco suizo
label_synchronization = Sincronización...
label_tab_chats = Chats
label_tab_monetization = Monetización
label_tab_settings = Ajustes
label_tab_wallet = Monedero
label_tapopa = Tapopa
label_tapopa_partner = Tapopa-Partner
label_tapopa_would_be_grateful = Tapopa agradecería mucho cualquier información sobre inconvenientes o problemas que haya encontrado.
label_tb = {$amount} TB
...
label_to_make_payment_secure_paypal_page_will_open = Para realizar el pago se abrirá una página segura de PayPal.
...
label_top_up_by_payment_card = Recarga con tarjeta de pago
...
label_transaction_is_ready_to_begin = La transacción está lista para comenzar.
label_transaction_unfinished = Transacción sin terminar.
label_tron_trc20 = TRON (TRC-20)
label_typing = Escribiendo
label_unique_clicks = Clics únicos
...
label_us_dollar = Dólar estadounidense
label_usdc = USDC
label_usdc_base = USDC - Base
label_usdc_crypto_exchange_platform = Plataforma de criptomonedas
label_usdc_crypto_exchange_platform_example = Binance, Bybit, Kraken, Coinbase, etc.
label_usdc_ethereum = USDC - Ethereum (ERC-20)
label_usdc_network_type = USDC - Tipo de red
label_usdc_optimism = USDC - Optimism (OP Mainnet)
label_usdc_tag_memo_etc = Identificador adicional de pago y/o del beneficiario
label_usdc_tag_memo_etc_example = Tag, memo, identificador, comentario, etc.
label_usdc_wallet_number = Número de la billetera
